    ...
    <section className="infoWrap dark">
      <div className="container">
        ...
        <p>
          <strong>
            제1조(개인정보의 처리 목적)
            <br />[ INSIDEBIG ]('clowncdi.github.io/weco'이하
            '오늘의날씨와경제') 은(는) 다음의 목적을 위하여 개인정보를
        ...
        <p>2. 재화 또는 서비스 제공</p>
        <p>콘텐츠 제공, 맞춤서비스 제공을 목적으로 개인정보를 처리합니다.</p>
        <p>3. 마케팅 및 광고에의 활용</p>
        <p>
          신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공
          및 참여기회 제공 , 서비스의 유효성 확인, 접속빈도 파악 또는 회원의
          서비스 이용에 대한 통계 등을 목적으로 개인정보를 처리합니다.
        </p>
        <p>
          <strong>제2조(개인정보의 처리 및 보유 기간)</strong>
          <br />① [ INSIDEBIG ] 은(는) 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <p>
          ① 정보주체는 INSIDEBIG에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는INSIDEBIG에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편 등을 통하여 하실 수 있으며
          INSIDEBIG은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ INSIDEBIG은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
          처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
          대리인인지를 확인합니다.
        </p>
        <p>
          <strong>제4조(처리하는 개인정보의 항목 작성) </strong> ① [ INSIDEBIG ]
        ...
        <p>
          ① [ INSIDEBIG ] 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
          ...
          <br />
          1. 파기절차 [ INSIDEBIG ] 은(는) 파기 사유가 발생한 개인정보를
          선정하고, [ INSIDEBIG ] 의 개인정보 보호책임자의 승인을 받아
          개인정보를 파기합니다.
        </p>
        <p>2. 파기방법</p>
        <p>
        ...
        <p>
          <strong>
            제6조(개인정보의 안전성 확보 조치)
            <br />[ INSIDEBIG ] 은(는) 개인정보의 안전성 확보를 위해 다음과 같은
            조치를 취하고 있습니다.
          </strong>
        </p>
        <p>
        ...
        <p>
          ① INSIDEBIG 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
        ...
        <p>
          ① INSIDEBIG 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
          개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여
          아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
        </p>
        <p>
          ② 정보주체께서는 INSIDEBIG 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. INSIDEBIG
          은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
        </p>
        <p>
          <strong>
            제9조(개인정보 열람청구) 정보주체는 ｢개인정보 보호법｣ 제35조에 따른
            개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. [ INSIDEBIG ]
        ...
        <p>① 이 개인정보처리방침은 2022년 2월 17부터 적용됩니다.</p>
      </div>
    </section>
  );
};
